...
/**
 * Created by debeyo on 04/04/2016.
 */
public class DetailFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private ShareActionProvider detailShareActionProvider;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        detailShareActionProvider = (ShareActionProvider) MenuItemCompat.getActionProvider(menuItem);
